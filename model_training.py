    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                mlflow.log_artifact("artifacts/train.csv", artifact_path="datasets")
                mlflow.log_artifact("artifacts/test.csv", artifact_path="datasets")
            ...
            raise CustomException("Failed to execute model training", e)
        finally:
